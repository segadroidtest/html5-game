...
(function (PhaserInput) {
  ...
  var InputField = (function (_super) {
      ...
      InputField.prototype.onEndFocus=function(){
          // console.log("HOla");
          if(this.callbackFunction!==null){
              this.callbackFunction(this.callbackContext);
          }
          
      };

      InputField.prototype.addEndFocusCallback=function(_func,_context){
          this.callbackFunction=_func;
