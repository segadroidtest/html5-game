  ...
  (this._init = function () {
    ...
    (this.disablePre = function () {
      ...
      (document.getElementsByTagName("body")[0].style.backgroundImage =
        'url("gzpAssets/loadBackground.png")'),
    ...
    (this._resizeHandle = function () {
      ...
      e > t
        ...
        : ((i.style.width = "65%"), (n.style.width = "65%")),
        this._moveFurther(0);
    }),
    ...
    (this._setDummy = function () {
      g =
        '<img id="dummyImg" style="display:none;" src="gzpAssets/loadBackground.png" />';
    }),
    (this._setProcessEnd = function () {
      r = "</div>";
    }),
    (this._setEmptyProcess = function () {
      h = '<img id="sadProcessbar" src="gzpAssets/gamezopUnfilled.png" />';
    }),
    (this._setFilledProcess = function () {
      c = '<img id="processbar" src="gzpAssets/gamezopFilled.png"/>';
    }),
    (this._setFilledPreload = function () {
      i = '<img id="underPreload" src="gzpAssets/filledPreload.png"/>';
    }),
    (this._setEmptyPreload = function () {
      s = '<img id="overPreload" src="gzpAssets/unfilledPreload.png"/>';
    }),
    ...
    (this._unload = function () {
      (document.getElementsByTagName("canvas")[0].style.display = "block"),
        ...
        (document.getElementsByTagName("body")[0].style.backgroundImage =
          "none"),
        1 != u && (gamezop.setState({ state: "loaded" }), (u = !0));
    }),
    this._init();
}
var GZLOADER = new gzpLoader();
