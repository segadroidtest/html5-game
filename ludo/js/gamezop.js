/*! For license information please see gamezop.js.LICENSE.txt */ ! function(t) {
	var e = {};
	...
	var r = n(136),
		...
		p = function(t) {
			return Object.assign(t, {
				_gzpDefProp: Object.defineProperty,
				_gzpDefProps: Object.defineProperties
			})
		},
		h = function(t) {
			t = t.replace(/[\[\]]/g, "\\$&");
		...
		m = function() {
			function t(e, n) {
				...
				}, this.gameCode = n, this.storageKey = "_gzp-".concat(e), this.paramsKey = "_gzp-params", this.userIdKey = "_gzp_userId", this.sessionKey = "_gzp_sessionKey", this.available = function() {
					try {
	...
	var w = function(t) {
		...
		_ = {
			shouldEnableFS: function() {
				return "kikBot" !== g.src && -1 === window.navigator.userAgent.indexOf("UCBrowser") && null === document.querySelector(".gzp-nofs")
			},
			getElem: function() {
				return document.querySelector(".gzpgame") || document.getElementById("c2canvas") || document.getElementsByTagName("canvas")[0] || document.body || document.documentElement
			},
			enableFS: function() {
				if (_.shouldEnableFS()) {
	...
	var r, o = n(34),
		...
		T = function() {
			...
			return u()(t, [{
				...
				value: function() {
					try {
						if (Object.keys(window.top).indexOf("gzpMsg") > -1) {
							var t = window.top.gzpMsg;
				...
				value: function(e) {
					...
					var a = document.title.replace("Gamezop - ", "");
					...
					var s = function(e) {
							Object(v.a)(e, "auth", (function() {
								...
								return n.error((t = JSON.stringify(e), new Error("Could not initialize Gamezop SDK ".concat(t || ""))));
								var t
							}))
						},
					...
					return h.c.pubId || this.storage.getParams(), this.storage.saveParams(), (u = {
						...
						n.debug && (n.log("Gamezop SDK has initialized"), console.group(), n.log(JSON.stringify(t.info())), n.log("Environment: ".concat(n.environment)), console.groupEnd())
					})).then((function() {
				...
				key: "warnDeprecation",
				value: function(t) {
					console.warn("gamezop.Initialize has been deprecated and will be removed in the next major version. Use gamezop.Init instead")
				}
			}], [{
				key: "info",
				value: function() {
	...
	var r = n(34),
		...
		d = "".concat("js/game.js").concat("").concat("").concat("");
	e.b = function(t) {
		return function(t) {
	...
	var r = n(0),
		...
		v = [function(t) {
			t && t.context && (p || (p = new d(t.context)), h || (h = setInterval((function() {
				return p.process()
			}), 5e3)), p.enqueue(t.data), "over" !== t.data.state && "start" !== t.data.state || p.process().then((function() {
				if ("over" === t.data.state) {
					var e = Object.assign(Object.assign({}, t.data), {
						state: "over-server"
					});
					Object(r.e)(Object(r.f)(e, t.gameCode, t.leaderboards))
				}
			})))
		}, function(t) {
